...
public class SJF extends Application{
	...
	public void start(Stage stage4) throws Exception {
        	...
        	if(at!="" && bt!="") {
            	...
            	if(temp.matches("\\d++")) {
            		if(sAT.length!=sBT.length) {
            			...
            			result.setText("Shortest Job First","SJF");
            			try {
							result.start(stage4);
						} catch (Exception e1) {
							e1.printStackTrace();
        ...
        stage4.getIcons().add(imgStage);
        stage4.setResizable(false);
        stage4.setTitle("Schedulling Algorithms----->SJF");
        stage4.show();
	}
